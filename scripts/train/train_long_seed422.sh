#!/bin/bash
# LIBERO-10 (Long) baseline, seed=422, GPU 2
# Paper recommends 150K steps; we use 100K as practical target (~3.5 days)
# 推荐运行方式: bash train_long_seed422.sh 2>&1 | tee runs/logs/long_seed422.log
